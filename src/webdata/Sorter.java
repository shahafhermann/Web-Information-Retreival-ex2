...
//        return new webdata.utils.Line(String.valueOf(term) + "#" + String.valueOf(numOfReviews) +
//                                      "#" + String.valueOf(freq));
//    }
//
//    /**
...
//                        createTempFiles();
//                    }
//                    productIdLines.add(createLine(productIdMap.get(term.group(1)), 1));
//                    line = reader.readLine();
//                    continue;
//                }
//
